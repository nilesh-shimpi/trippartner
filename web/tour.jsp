...
<head>
    ...
    <title>Tours &#8211; Exploore &#8211; Travel, Exploration, Booking WordPress Theme</title>
    <style>
        ...
        <div id="wrapper-content">
            ...
            <div class="main-content">
                ...
                <div class="tour-result-main padding-top padding-bottom">
                    ...
                    <div class="container">
                        <div class="slz-shortcode block_17655493735b8d04f6c80d9 slz-tour-category" data-id="block_17655493735b8d04f6c80d9">
                            <div class="list-continents"><div class="list-continent-wrapper"><a href="http://wp.swlabs.co/exploore/tour-category/africa/" class="continent " data-slug="africa">
                                <i class="icons fa fa-map-marker"></i><span class="text">Africa</span>
                            </a>
                                <div class="des"></div>
                            </div><div class="list-continent-wrapper"><a href="http://wp.swlabs.co/exploore/tour-category/america/" class="continent " data-slug="america">
                                <i class="icons fa fa-map-marker"></i><span class="text">America</span>
                            </a>
                                <div class="des"></div>
                            </div><div class="list-continent-wrapper"><a href="http://wp.swlabs.co/exploore/tour-category/asian/" class="continent " data-slug="asian">
                                <i class="icons fa fa-map-marker"></i><span class="text">Asian</span>
                            </a>
                                <div class="des"></div>
                            </div><div class="list-continent-wrapper"><a href="http://wp.swlabs.co/exploore/tour-category/domestic/" class="continent " data-slug="domestic">
                                <i class="icons fa fa-map-marker"></i><span class="text">Domestic</span>
                            </a>
                                <div class="des"></div>
                            </div><div class="list-continent-wrapper"><a href="http://wp.swlabs.co/exploore/tour-category/europe/" class="continent " data-slug="europe">
                                <i class="icons fa fa-map-marker"></i><span class="text">Europe</span>
                            </a>
                                <div class="des"></div>
                            </div></div></div>		<div class="result-body block-1635767865b8d04f6cb2a8">
                        <div class="row">
                                            ...
                                            <div class="text-input small-margin-top">
                                                <div class="text-box-wrapper">
                                                    ...
                                                    <div class="input-group">
                                                        <input class="tb-input" placeholder="Enter a keyword" type="text" name="keyword" />					</div>
                                                </div>
                                                <div class="text-box-wrapper">
                                                    <label class="tb-label">
                                                        Where?					</label>
                                            ...
                                            <div class="city-widget widget">
                                                ...
                                                <div class="content-widget">
                                                    ...
                                                    <div class="radio-selection">
                                                        ...
                                                        <div class="radio-btn-wrapper">
                                                            <input type="checkbox" name="location" checked value="london" id="london" class="radio-btn">
                                                        ...
                                                        <div class="radio-btn-wrapper">
                                                            <input type="checkbox" name="location"  value="spain" id="spain" class="radio-btn">
                                                            <label for="spain" class="radio-label">Spain</label>
                                                            <span class="count">1</span>
                                                        </div>
                                                        <div class="radio-btn-wrapper">
