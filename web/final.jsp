...
<head>
    ...
    <title>Checkout &#8211; Exploore &#8211; Travel, Exploration, Booking WordPress Theme</title>
    <style>
    ...
    <link rel='stylesheet' id='select2-css'  href='//wp.swlabs.co/exploore/wp-content/plugins/woocommerce/assets/css/select2.css?ver=2.6.14' type='text/css' media='all' />
    ...
    <script type='text/javascript'>
        /* <![CDATA[ */
        var wc_add_to_cart_params = {"ajax_url":"\/exploore\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/exploore\/checkout\/order-received\/8727\/?key=wc_order_5b8cba6e89b82&wc-ajax=%%endpoint%%","i18n_view_cart":"View Cart","cart_url":"http:\/\/wp.swlabs.co\/exploore\/cart\/","is_cart":"","cart_redirect_after_add":"no"};
        /* ]]> */
    </script>
    ...
    <script type='text/javascript'>
        /* <![CDATA[ */
        var _zxcvbnSettings = {"src":"http:\/\/wp.swlabs.co\/exploore\/wp-includes\/js\/zxcvbn.min.js"};
        /* ]]> */
    </script>
    <script type='text/javascript' src='http://wp.swlabs.co/exploore/wp-includes/js/zxcvbn-async.min.js?ver=1.0'></script>
    ...
    <link rel="canonical" href="http://wp.swlabs.co/exploore/checkout/" />
    <link rel='shortlink' href='http://wp.swlabs.co/exploore/?p=662' />
    <link rel="alternate" type="application/json+oembed" href="http://wp.swlabs.co/exploore/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fwp.swlabs.co%2Fexploore%2Fcheckout%2F" />
    <link rel="alternate" type="text/xml+oembed" href="http://wp.swlabs.co/exploore/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fwp.swlabs.co%2Fexploore%2Fcheckout%2F&#038;format=xml" />
...
<body class="page page-id-662 page-template-default woocommerce-checkout woocommerce-page woocommerce-order-received  sticky-enable  searchbar-type-2 wpb-js-composer js-comp-ver-5.0.1 vc_responsive" data-class="header-five">
                ...
                <div class="header-main">
                    <div class="container">
                        <div class="header-main-wrapper">
                            ...
                            <nav class="navigation"><ul id="menu-main-navigation-1" class="nav-links nav navbar-nav slzexploore-menu"><li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-548 dropdown menu-item-depth1" ><a class="main-menu"  href="http://wp.swlabs.co/exploore/"><i class="fa  "></i>Home<span class="icons-dropdown"><i class="fa fa-angle-down"></i></span></a><ul class="dropdown-menu dropdown-menu-1 exploore-dropdown-menu-1">	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-553" ><a class="link-page"  href="http://wp.swlabs.co/exploore/"><i class="fa  "></i>Home Page Default</a></li>
                                ...
                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-554 dropdown menu-item-depth1" ><a class="main-menu"  href="http://wp.swlabs.co/exploore/hotelRoomsInfos-list/"><i class="fa  "></i>Hotels<span class="label label-danger">New</span><span class="icons-dropdown"><i class="fa fa-angle-down"></i></span></a><ul class="dropdown-menu dropdown-menu-1 exploore-dropdown-menu-1">	<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-535" ><a class="link-page"  href="http://wp.swlabs.co/exploore/accommodations"><i class="fa  "></i>Hotels Search</a></li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-557" ><a class="link-page"  href="http://wp.swlabs.co/exploore/hotelRoomsInfos-list/"><i class="fa  "></i>Hotels List  Layout 01</a></li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1639" ><a class="link-page"  href="http://wp.swlabs.co/exploore/hotelRoomsInfo-list-02/"><i class="fa  "></i>Hotels List Layout 02</a></li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3813" ><a class="link-page"  href="http://wp.swlabs.co/exploore/hotelRoomsInfo-grid/"><i class="fa  "></i>Hotel Grid<span class="label label-danger">New</span></a></li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-slzexploore_hotel menu-item-1686" ><a class="link-page"  href="http://wp.swlabs.co/exploore/accommodations/kadirly-hotelRoomsInfo/"><i class="fa  "></i>Hotel View</a></li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-slzexploore_hotel menu-item-2331" ><a class="link-page"  href="http://wp.swlabs.co/exploore/accommodations/edemil-hotelRoomsInfo/"><i class="fa  "></i>Hotel View &#038; Deposit mode</a></li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2740" ><a class="link-page"  href="http://wp.swlabs.co/exploore/hotelRoomsInfos-map/"><i class="fa  "></i>Hotels Map<span class="label label-danger">New</span></a></li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-slzexploore_hotel menu-item-2788" ><a class="link-page"  href="http://wp.swlabs.co/exploore/accommodations/sarina-hotelRoomsInfo/"><i class="fa  "></i>Book Hotel With Contact Form<span class="label label-success">New</span></a></li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-slzexploore_hotel menu-item-2945" ><a class="link-page"  href="http://wp.swlabs.co/exploore/accommodations/matel-hotelRoomsInfo/"><i class="fa  "></i>Booking Hotel Or Book With Contact Form<span class="label label-success">New</span></a></li>
                                </ul></li>
                    ...
                    <div class="container">
                        <div class="page-title-wrapper">
                            <div class="page-title-content">
                                <ol class="breadcrumb"><li><a href="http://wp.swlabs.co/exploore/" class="link home">Home</a></li><li class="active"><a href="http://wp.swlabs.co/exploore/checkout/" class="link">Checkout</a></li></ol>				<div class="clearfix"></div>
                                <h2 class="captions">
                                    Checkout					</h2>
                            </div>
                        </div>
                                        ...
                                        <div class="entry-content">
                                            <div class="woocommerce">
                                                ...
                                                <ul class="woocommerce-thankyou-order-details order_details">
                                                    <li class="order">
                                                        Order Number:				<strong>8727</strong>
                                                    </li>
                                                    <li class="date">
                                                        Date:				<strong>September 3, 2018</strong>
                                                    </li>
                                                    <li class="total">
                                                        Total:				<strong><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>30.00</span></strong>
                                                    </li>
                                                    <li class="method">
                                                        Payment Method:				<strong>Case On Delivery</strong>
                                                    </li>
                                                </ul>
                                                <div class="clear"></div>
                                                ...
                                                <table class="shop_table order_details">
                                                    ...
                                                    <tr class="order_item">
                                                        <td class="product-name">
                                                            Edemil Hotel <strong class="product-quantity">&times; 1</strong><dl class="variation">
                                                            <dt class="variation-RoomType">Room Type:</dt>
                                                            <dd class="variation-RoomType"><p>Family Room</p>
                                                            </dd>

                                                            <dt class="variation-Numberroom">Number room:</dt>
                                                            <dd class="variation-Numberroom"><p>1</p>
                                                            </dd>

                                                            <dt class="variation-Checkindate">Check in date:</dt>
                                                            <dd class="variation-Checkindate"><p>September 3, 2018</p>
                                                            </dd>

                                                            <dt class="variation-Checkoutdate">Check out date:</dt>
                                                            <dd class="variation-Checkoutdate"><p>September 3, 2018</p>
                                                            </dd>

                                                            <dt class="variation-Adults">Adults:</dt>
                                                            <dd class="variation-Adults"><p>1</p>
                                                            </dd>
                                                        </dl>	</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>30.00</span></td>
                                                    </tr>
                                                    <tr>
...
<div class="hidden-sm hidden-xs" id="theme-setting">
    ...
    <div class="theme-setting-content">
        ...
        <form action="" id="header-options-form" method="get">
            ...
            <input type="hidden" name="key" value="wc_order_5b8cba6e89b82">		</form>
        <div class="layout-options">
...
<script type='text/javascript' src='//wp.swlabs.co/exploore/wp-content/plugins/woocommerce/assets/js/select2/select2.min.js?ver=3.5.4'></script>
<script type='text/javascript'>
    /* <![CDATA[ */
    var pwsL10n = {"short":"Very weak","bad":"Weak","good":"Medium","strong":"Strong","mismatch":"Mismatch"};
    /* ]]> */
</script>
<script type='text/javascript' src='http://wp.swlabs.co/exploore/wp-admin/js/password-strength-meter.min.js?ver=4.5.3'></script>
<script type='text/javascript'>
    /* <![CDATA[ */
...
<script type='text/javascript' src='//wp.swlabs.co/exploore/wp-content/plugins/woocommerce/assets/js/frontend/password-strength-meter.min.js?ver=2.6.14'></script>
...
<script type='text/javascript'>
    /* <![CDATA[ */
    var woocommerce_params = {"ajax_url":"\/exploore\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/exploore\/checkout\/order-received\/8727\/?key=wc_order_5b8cba6e89b82&wc-ajax=%%endpoint%%"};
    /* ]]> */
</script>
...
<script type='text/javascript'>
    /* <![CDATA[ */
    var wc_checkout_params = {"ajax_url":"\/exploore\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/exploore\/checkout\/order-received\/8727\/?key=wc_order_5b8cba6e89b82&wc-ajax=%%endpoint%%","update_order_review_nonce":"72cc21463a","apply_coupon_nonce":"b200eca08d","remove_coupon_nonce":"a401e68338","option_guest_checkout":"yes","checkout_url":"\/exploore\/checkout\/order-received\/8727\/?key=wc_order_5b8cba6e89b82&wc-ajax=checkout","is_checkout":"0","debug_mode":"","i18n_checkout_error":"Error processing checkout. Please try again."};
    /* ]]> */
</script>
<script type='text/javascript' src='//wp.swlabs.co/exploore/wp-content/plugins/woocommerce/assets/js/frontend/checkout.min.js?ver=2.6.14'></script>
...
<script type='text/javascript'>
    /* <![CDATA[ */
    var wc_cart_fragments_params = {"ajax_url":"\/exploore\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/exploore\/checkout\/order-received\/8727\/?key=wc_order_5b8cba6e89b82&wc-ajax=%%endpoint%%","fragment_name":"wc_fragments"};
    /* ]]> */
</script>
