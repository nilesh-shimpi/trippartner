...
<head>
    ...
    <title>Checkout &#8211; &#8211; Travel, Exploration, Booking WordPress Theme</title>
    <style>
    ...
    <script type='text/javascript'>
        /* <![CDATA[ */
        var wc_add_to_cart_params = {"ajax_url":"\/exploore\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/exploore\/checkout\/?wc-ajax=%%endpoint%%","i18n_view_cart":"View Cart","cart_url":"http:\/\/wp.swlabs.co\/exploore\/cart\/","is_cart":"","cart_redirect_after_add":"no"};
        /* ]]> */
    </script>
...
<body class="page page-id-662 page-template-default woocommerce-checkout woocommerce-page  sticky-enable  searchbar-type-2 wpb-js-composer js-comp-ver-5.0.1 vc_responsive" data-class="header-five">
                                        ...
                                        <div class="entry-content">
                                            <div class="woocommerce">
                                                ...
                                                <form method="post" class="login" style="display:none;">
                                                    ...
                                                    <p class="form-row">
                                                        <input type="hidden" id="_wpnonce" name="_wpnonce" value="c9ce0c16ca" /><input type="hidden" name="_wp_http_referer" value="/exploore/checkout/" />		<input type="submit" class="button" name="login" value="Login" />
                                                        <input type="hidden" name="redirect" value="http://wp.swlabs.co/exploore/checkout/" />
                                                        <label for="rememberme" class="inline">
                                                            <input name="rememberme" type="checkbox" id="rememberme" value="forever" /> Remember me		</label>
                                                    </p>
                                                    <p class="lost_password">
                                                        <a href="http://wp.swlabs.co/exploore/shop/my-account/lost-password/">Lost your password?</a>
                                                    </p>
                                                ...
                                                <form name="checkout" method="post"  action="final.jsp" enctype="multipart/form-data">
                                                        ...
                                                        <table class="shop_table woocommerce-checkout-review-order-table">
                                                            ...
                                                            <tr class="cart_item">
                                                                <td class="product-name">
                                                                    <a href="http://wp.swlabs.co/exploore/accommodations/edemil-hotelRoomsInfo/">Edemil Hotel</a><br/>Room Type: Family Room<br/>Number room: 1<br/>Check in date: August 26, 2018<br/>Check out date: August 26, 2018<br/>Adults: 1<br/>&nbsp;							 <strong class="product-quantity">&times; 1</strong>													</td>
...
<script type='text/javascript'>
    /* <![CDATA[ */
    var woocommerce_params = {"ajax_url":"\/exploore\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/exploore\/checkout\/?wc-ajax=%%endpoint%%"};
    /* ]]> */
</script>
...
<script type='text/javascript'>
    /* <![CDATA[ */
    var wc_checkout_params = {"ajax_url":"\/exploore\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/exploore\/checkout\/?wc-ajax=%%endpoint%%","update_order_review_nonce":"d5cf51c131","apply_coupon_nonce":"b742e195c7","remove_coupon_nonce":"9b2caf0110","option_guest_checkout":"yes","checkout_url":"\/exploore\/checkout\/?wc-ajax=checkout","is_checkout":"1","debug_mode":"","i18n_checkout_error":"Error processing checkout. Please try again."};
    /* ]]> */
</script>
...
<script type='text/javascript'>
    /* <![CDATA[ */
    var wc_cart_fragments_params = {"ajax_url":"\/exploore\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/exploore\/checkout\/?wc-ajax=%%endpoint%%","fragment_name":"wc_fragments"};
    /* ]]> */
</script>
